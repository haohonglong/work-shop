...
//        $webRoot = \Yii::$app->request->baseUrl . '/';
        ...
        //第二步 裁减成圆角图片
        $imgs['src'] = $this->test($imggzip, $saveRoot . $saveDir, (int)$this->avatar_w, (int)$this->avatar_w);
        $qrcode_info = getimagesize($qrcode);
        $imgs['qrcode'] = $this->test($qrcodezip, $saveRoot . $saveDir, (int)$this->qrcode_w, (int)$this->qrcode_w, $this->qrcode_true);
        //第三步 合并图片
